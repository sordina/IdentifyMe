...
-- declared in the IdentifyMe.hs file.
module Settings
    ( widgetFile
    , staticRoot
    , staticDir
...
--
-- If you change the resource pattern for StaticR in IdentifyMe.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in IdentifyMe.hs
